...
function getMovesCount(beans: Movement[], lines: string[]): number {
    let sum = 0;
...
function main(input: string) {
    ...
    for (let i = 0; i < lines.length; i++) {
        let beans: Movement[] = [[[i, -1], [0, 1]]];
        const c = getMovesCount(beans, lines);
        max = Math.max(c, max);
    }
    for (let i = 0; i < lines.length; i++) {
        let beans: Movement[] = [[[i, lines[0].length], [0, -1]]];
        const c = getMovesCount(beans, lines);
        max = Math.max(c, max);
    }
    for (let j = 0; j < lines[0].length; j++) {
        let beans: Movement[] = [[[-1, j], [1, 0]]];
        const c = getMovesCount(beans, lines);
        max = Math.max(c, max);
    }
    for (let j = 0; j < lines[0].length; j++) {
        let beans: Movement[] = [[[lines.length, j], [-1, 0]]];
        const c = getMovesCount(beans, lines);
        max = Math.max(c, max);
    }
